        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 p-2 bg-gray-100 rounded-lg shadow-inner">
             <div className="flex flex-wrap items-center justify-center gap-2">
                <span className="font-semibold text-gray-700 mr-2">{t('propertyListings.filterDepartment')}:</span>
             ...
             <div className="flex flex-wrap items-center justify-center gap-2">
                 <span className="font-semibold text-gray-700 mr-2">{t('propertyListings.filterType')}:</span>
            ...
            {filteredProperties.map((prop) => (
              ...
              >
                <div className="relative">
                  <img className="w-full h-48 object-cover" alt={`${t('propertyListings.propertyIn')} ${prop.location}`} src="https://images.unsplash.com/photo-1599809275671-b5942cabc7a2" />
                  <div className="absolute top-0 right-0 bg-blue-600 text-white font-bold px-3 py-1 m-2 rounded-full text-sm">{t(`propertyListings.types.${prop.type.toLowerCase()}`)}</div>
                  <div className="absolute top-0 left-0 bg-gray-800 text-white font-semibold px-2 py-1 m-2 rounded-full text-xs">{t(`propertyListings.departments.${prop.department.toLowerCase()}`)}</div>
                </div>
